...
public abstract class BucketListAdapterProduct<T> extends BaseAdapter {

    protected List<ListProduct> elements;
    protected Activity ctx;
    protected Integer bucketSize;

    public BucketListAdapterProduct(Activity ctx, List<ListProduct> elements) {
        this(ctx, elements, 1);
    }

    public BucketListAdapterProduct(Activity ctx, List<ListProduct> elements, Integer bucketSize) {
